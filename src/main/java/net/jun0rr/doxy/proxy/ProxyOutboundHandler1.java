 ...
 * @author juno
 */
public class ProxyOutboundHandler1 extends ChannelOutboundHandlerAdapter {
  ...
  public static ProxyOutboundHandler1 of(
      Consumer<ChannelWriteContext> writeHandler,
      Consumer<ChannelErrorContext> errorHandler
  ) {
    return new ProxyOutboundHandler1(writeHandler, errorHandler);
  }
  
  public static ProxyOutboundHandler1 of(
      Consumer<ChannelWriteContext> writeHandler
  ) {
    return new ProxyOutboundHandler1(writeHandler, DEFAULT_ERROR_LOGGER);
  }
